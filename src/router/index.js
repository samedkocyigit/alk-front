    ...
    children: [
      {
        ...
        component: () => import('@/views/dashboard/manageItems/CreateProductView.vue'),
      },
      {
        path: 'create-brand',
        name: 'create-brand',
        meta: { requiresAuth: true },
        component: () => import('@/views/dashboard/manageItems/CreateBrandView.vue'),
      },
      {
        path: 'create-category',
        name: 'create-category',
        meta: { requiresAuth: true },
        component: () => import('@/views/dashboard/manageItems/CreateCategoryView.vue'),
      },
      {
        path: 'create-campaign',
        name: 'create-campaign',
        meta: { requiresAuth: true },
        component: () => import('@/views/dashboard/manageItems/CreateCampaignView.vue'),
      },
      {
        path: 'update-campaign',
        name: 'update-campaign',
        meta: { requiresAuth: true },
        component: () => import('@/views/dashboard/manageItems/UpdateCampaignView.vue'),
      },
      {
