    ...
    <div class="fixed flex flex-col left-0 top-40 h-[calc(100vh-90px)] w-[270px] bg-white border-r-2 z-[1]">
      ...
      <div class="flex p-4 border-b-[1px] mt-10">
        ...
        <div class="flex flex-col ml-3">
          <span class="text-base font-bold">{{ authStore.state.user.name }}</span>
          <span class="text-xs text-primary-200">
            <span class="ml-1">{{ authStore.state.user.email }}</span>
          </span>
        </div>
      </div>
      <!-- end header info -->
      ...
      <div
        ...
        class="flex flex-col justify-between flex-auto gap-3 px-5 py-5 pb-1"
      >
        ...
        <div class="flex flex-col gap-2 text-base text-primary-200">
          ...
          <div class="cursor-pointer flex items-center" @click="toggleProductMenu">
            <i class="ri-shopping-bag-3-fill text-2xl ml-2 mr-3"></i> Create New Items
          </div>
          <!-- Product Menu -->
      ...
      <div v-else class="flex flex-col justify-between flex-auto gap-3 px-5 py-5 pb-1">
        <div class="flex flex-col gap-2 text-base text-primary-200">
          ...
          <RouterLink to="/dashboard/orders" class="px-2 py-1 rounded-md flex items-center">
            <i class="ri-handbag-fill text-2xl mr-3"></i>Siparişlerim
          </RouterLink>
